...
public class ManageBook extends javax.swing.JFrame {
    ...
    public ManageBook() {
        ...
        int book_id = bookIdToTextField();
        txt_bookid.setText(Integer.toString(book_id));
    }
    ...
    public int bookIdToTextField() {
        int bookId = 0;
        try {
            Connection con = DBConnection.getConnection();
            PreparedStatement pst = con.prepareStatement("select max(book_id) from book_details");
    ...
    public boolean validateBookDetails() {
        ...
        if (authorName.equals("")) {
            JOptionPane.showMessageDialog(this, "Please Enter Authorname");
            return false;
        }
        if (quantity.equals("")) {
    ...
    public boolean checkDuplicateBook() {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/libray_ms", "root", "");
            PreparedStatement pst = con.prepareStatement("Select * from book_details where book_id = ? and book_name = ? and author = ? and quantity = ?");
            pst.setInt(1, bookId);
    ...
    private void initComponents() {
        ...
        pnl_back.setBackground(new java.awt.Color(0, 0, 0));
        pnl_back.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                pnl_backMouseEntered(evt);
            }
        ...
        lbl_back.setFont(new java.awt.Font("Segoe UI", 1, 20)); // NOI18N
        ...
        pnl_backLayout.setHorizontalGroup(
            ...
            .addGroup(pnl_backLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_back, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        pnl_backLayout.setVerticalGroup(
            ...
            .addGroup(pnl_backLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lbl_back, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        jPanel1.add(pnl_back, new org.netbeans.lib.awtextra.AbsoluteConstraints(2, 2, -1, 50));
        ...
        jLabel8.setText(" ");
        jPanel1.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 210, 50, -1));
        ...
        jPanel1.add(txt_bookid, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 212, 300, -1));
        ...
        txt_bookname.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        txt_bookname.setFont(new java.awt.Font("Serif", 1, 17)); // NOI18N
        ...
        jPanel1.add(txt_bookname, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 312, 300, -1));
        ...
        txt_authorname.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        txt_authorname.setFont(new java.awt.Font("Serif", 1, 17)); // NOI18N
        txt_authorname.setPlaceholder("Enter Author Name...");
        jPanel1.add(txt_authorname, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 412, 300, -1));
        ...
        txt_quantity.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(0, 0, 0)));
        txt_quantity.setFont(new java.awt.Font("Serif", 1, 17)); // NOI18N
        txt_quantity.setPlaceholder("Enter Quantity...");
        jPanel1.add(txt_quantity, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 512, 300, -1));
        ...
        jPanel1.add(btn_update, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 640, 140, 50));
        ...
        jPanel1.add(btn_delete, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 640, 140, 50));
        ...
        tbl_bookdetails.setColorBackgoundHead(new java.awt.Color(255, 255, 255));
        ...
        tbl_bookdetails.setFont(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_bookdetails.setFuenteFilas(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_bookdetails.setFuenteFilasSelect(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_bookdetails.setFuenteHead(new java.awt.Font("Serif", 1, 27)); // NOI18N
        tbl_bookdetails.setGridColor(new java.awt.Color(255, 255, 255));
        tbl_bookdetails.setRowHeight(50);
        ...
        jLabel16.setFont(new java.awt.Font("Serif", 1, 37)); // NOI18N
        jLabel16.setText("Manage Books");
        jPanel1.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 45, 230, -1));
        ...
        jPanel1.add(jPanel34, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 95, 300, 3));
        ...
        jPanel1.add(jLabel17, new org.netbeans.lib.awtextra.AbsoluteConstraints(1495, 0, 20, 40));
        ...
        jPanel1.add(btn_add, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 640, 140, 50));
    ...
    private void pnl_backMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_pnl_backMouseEntered

    }//GEN-LAST:event_pnl_backMouseEntered
