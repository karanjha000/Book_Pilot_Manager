...
public class DefaulterList extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, -1, 40));
        ...
        tbl_defaulterlist.setBorder(new javax.swing.border.MatteBorder(null));
        ...
        tbl_defaulterlist.setColorBackgoundHead(new java.awt.Color(255, 255, 255));
        tbl_defaulterlist.setColorFilasBackgound2(new java.awt.Color(255, 255, 255));
        tbl_defaulterlist.setColorForegroundHead(new java.awt.Color(0, 0, 0));
        tbl_defaulterlist.setColorSelBackgound(new java.awt.Color(0, 0, 0));
        tbl_defaulterlist.setFont(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_defaulterlist.setFuenteFilas(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_defaulterlist.setFuenteFilasSelect(new java.awt.Font("Sitka Text", 0, 22)); // NOI18N
        tbl_defaulterlist.setFuenteHead(new java.awt.Font("Serif", 1, 22)); // NOI18N
        tbl_defaulterlist.setRowHeight(50);
        jScrollPane1.setViewportView(tbl_defaulterlist);
